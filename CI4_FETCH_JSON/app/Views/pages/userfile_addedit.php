...
<?= $this->section('content')?>
    <div class="pagetitle">
        <nav class="float-end">
            ...
            <li class="breadcrumb-item active"><?= isset($data_recordfile[0]['userid']) && $data_recordfile[0]['userid'] != "" ? "Edit" : "Add"; ?> User Account</li>
            </ol>
        </nav>
        <h1>User Account</h1>
    </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title "><?= isset($data_recordfile[0]['userid']) && $data_recordfile[0]['userid'] != "" ? "Edit" : "Save" ?> User Account</h5>
                        <form name="myform" id="myform" 
                            class="row g-4 needs-validation <?= isset($data_recordfile[0]['userid']) && $data_recordfile[0]['userid'] != "" ? "update" : "save" ?>" 
                            method="POST"
                            autocomplete="off"
                            ...
                            <div class="col-lg-6">
                                <div class="form-floating">
                                    <input type="text" name="txtfld[username]" id="txtusername"
                                            class="form-control form-control-sm" placeholder="Your Username"
                                            value="<?= isset($data_recordfile[0]['username']) && $data_recordfile[0]['username'] ? $data_recordfile[0]['username'] : ""?>"
                                            required>
                                    <label for="txtusername"><small>Username</small></label>
                                    <div class="invalid-tooltip">
                            ...
                            <div class="col-lg-6">
                                <div class="form-floating">
                                    <select name="txtfld[usertype]" id="txtusertype"
                                            class="form-control form-control-sm" placeholder="Your User Type"
                                            required>
