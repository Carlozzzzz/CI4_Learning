...
$xobj = "";
	...
	{
	    $xobj .= "<tr>";
	    	$xobj .= "<td style=\"padding:15px; width:660px; border: 1px solid black; text-align: center;\"><b>TEACHER LIST</b></td>";
	    $xobj .= "</tr>";

	    $xobj .= "<tr>";
    		$xobj .= "<td style=\"padding:15px; width:40px; border: 1px solid black; text-align:center;\"><b>#</b></td>";
    		$xobj .= "<td style=\"padding:15px; width:100px; border: 1px solid black; text-align:center;\"><b>Teacher No.</b></td>";
    		$xobj .= "<td style=\"padding:15px; width:520px; border: 1px solid black; text-align:center;\"><b>Teacher Name</b></td>";
	    $xobj .= "</tr>";
	    ...
	    foreach ($data_datatablefile1 as $key => $value) 
	    {
		    $xobj .= "<tr>";
	    		...
	    		$xobj .= "<td style=\"padding:15px; width:100px; border-left: 1px solid black; text-align: center;\">{$value['teacherid']}</td>";
