...
<?= $this->section('content')?>
    ...
    <div class="pagetitle">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url();?>studentsubjectlistfile/viewstudents" onclick="$.blockUI();">Student</a></li>
                ...
                <div class="card info-card sales-card">
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item" href="<?= base_url().$data_activepage;?>/addnew/<?= isset($data_studentid) && $data_studentid != "" ? $data_studentid : "" ?>" role="button" onclick="$.blockUI();"><i class="bi bi-plus-lg"></i> Add new</a></li>
                                    ...
                                    <tr>
                                        <th class="text-left not-sortable" scope="col">
                                            <div class="form-check form-switch small align-end m-0">
                                                <input type="checkbox" class="form-check-input" role="switch" onchange="viewactive(this);" <?= $data_isactive == 1 ? "checked" : "";?> id="txtcheckactive" data-toggle="tooltip" title="Tick to view <?= $data_isactive == 1 ? "Inactive" : "Active";?> Student Subjects" disabled>
                                                <small>No.</small>
                                            </div>
                                        </th>
                                        <th>Teacher</th>
                                ...
                                <tbody>
                                    <?php  foreach($data_recordfile as $key => $value) :?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Assign Subjects" onclick="resetpass(this);" id="<?= $value['studentsfid']; ?>"><i class="bi bi-pencil-square"></i></button>
