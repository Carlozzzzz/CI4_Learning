                                    ...
                                    <?php  foreach($data_recordfile as $key => $value) :?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php else:?>
                                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Reset" onclick="resetpass(this);" id="<?= $value['studentno']; ?>"><i class="bi bi-arrow-clockwise"></i></button>
