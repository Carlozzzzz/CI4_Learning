...
<?= $this->section('content')?>
    <div class="pagetitle">
        <nav class="float-end">
            ...
            <li class="breadcrumb-item active"><?= isset($data_recordfile[0]['studentid']) && $data_recordfile[0]['studentid'] != "" ? "Edit" : "Add"; ?> Student Account</li>
            </ol>
        </nav>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title "><?= isset($data_recordfile[0]['studentid']) && $data_recordfile[0]['studentid'] != "" ? "Edit" : "Save" ?> Student Account</h5>
