    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="d-flex align-items-center justify-content-between">
            <a href="<?= base_url(); ?>dashboard" class="logo d-flex align-items-center">
                <img class="" src="<?= base_url() ?>assets/img/tiktak_logo.png" alt="WebApps Logo">
                <span class="d-none d-lg-block">Tik-tak-tuss</span>
            </a>
        ...
        <ul class="sidebar-nav" id="side-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <?= $xcollapsed;?>" data-bs-target="#registration-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-file-earmark-text"></i><span>Tiktak Versions</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
