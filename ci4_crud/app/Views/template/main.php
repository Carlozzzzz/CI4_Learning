    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="d-flex align-items-center justify-content-between">
            <a href="<?= base_url(); ?>dashboard" class="logo d-flex align-items-center">
                <img class="" src="<?= base_url(); ?>assets/img/logo.png" alt="WebApps Logo">
                <span class="d-none d-lg-block">Patatas</span>
            </a>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="side-nav">
            ...
            <?php 
                ...
                if($data_activepage == "studentfile" || $data_activepage == "userfile")
                {
                    $xcollapsed = "";
                    $xshow = "show";
                    $xactive = "active";
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link <?= $xcollapsed;?>" data-bs-target="#account-nav" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-file-earmark-text"></i><span>Accounts</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="account-nav" class="nav-content collapse<?= $xshow; ?>" data-bs-parent="#sidebar-nav">
                    <?php
                        $xcollapsed = "collapsed";
                        $xshow = "";
                        $xactive = "";
                    ...
                    <li class="nav-item">
                        ...
                        <ul id="userfile-nav" class="nav-content collapse <?= $xshow?>" data-bs-parent="#account-nav">
                            <?php
                                $xactive = "";
            ...
            <?php 
                $xcollapsed = "collapsed";
                if($data_activepage == "encryptfile"){
                    $xcollapsed = "";
                }
            ?>
            <li class="nav-item">
                <a class="nav-link <?= $xcollapsed?>" href="<?= base_url(); ?>encryptfile">
                    <i class="bi bi-speedometer2"></i>
